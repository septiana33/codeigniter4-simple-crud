...
<a href="<?= base_url('posts') ?>" class="btn btn-secondary" title="Kembali">
...
<form method="POST" action="<?= base_url('posts/store') ?>">
    ...
    <div>
        ...
        <input type="text" class="form-control" id="title" name="title" maxlength="100" autocomplete="off" value="<?= old('title') ?>">
    </div>
    <div class="mt-5">
        <label for="content" class="form-label">Konten Postingan</label>
        <textarea class="form-control" id="content" name="content" rows="10" autocomplete="off" style="resize: none"><?= old('content') ?></textarea>
    </div>
