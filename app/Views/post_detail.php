...
<a href="<?= base_url('posts/edit?id=' . $id) ?>" class="btn btn-primary" title="Ubah Postingan">
...
<a href="<?= base_url('posts/delete?id=' . $id) ?>" class="btn btn-danger" title="Hapus Postingan">
